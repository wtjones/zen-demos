...
DEF SUB_TILE_TOP_LEFT_MASK      EQU %00000001
DEF SUB_TILE_BOTTOM_LEFT_MASK   EQU %00000010
DEF SUB_TILE_BOTTOM_RIGHT_MASK  EQU %00000100
DEF SUB_TILE_TOP_RIGHT_MASK     EQU %00001000
